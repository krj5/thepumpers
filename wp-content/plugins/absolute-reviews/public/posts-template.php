		...
		<div class="abr-post-outer">
			...
			<div class="abr-post-inner abr-post-data">
				...
				<div class="abr-post-headline">
					<?php
						abr_get_post_meta( 'category', (bool) $params['post_meta_compact'], true, $params['post_meta_list'] );
					?>
					...
					<?php
						abr_get_post_meta( abr_allowed_post_meta( true, 'category' ), (bool) $params['post_meta_compact'], true, $params['post_meta_list'] );
					?>
				</div>
